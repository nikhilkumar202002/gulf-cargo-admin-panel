...
const PrivateRoute = ({ children }) => {
  ...
  if (!isInitialized && !token && !storedToken) return <Navigate to="/login" replace />;
...
const LayoutWithRole = () => {
  ...
  const { roleId } = getRoleInfo(user);
  return <Layout userRole={roleId} authResolving={!isInitialized} />;
};
...
const ShippingReport = lazy(() => import("../features/Shipments/ShipmentReport"));
...
const ViewCargo = lazy(() => import("../features/Cargo/ViewCargo"));

const UserProfile = lazy(() => import("../features/Auth/UserProfile"));
...
// const ShipmentReport = lazy(() => import("../features/Shipments/ShipmentReport"));
...
const InvoiceView = lazy(() => import("../features/Finance/Invoices/InvoiceView"));
const CustomerManifest = lazy(() => import("../features/Operations/Excels/CustomManifest"));
const DeliveryList = lazy(() => import("../features/Operations/Excels/DeliveryList"));
const LoadingList = lazy(() => import("../features/Operations/Excels/LoadingList"));
const PackingList = lazy(() => import("../features/Operations/Excels/PackingList"));
...
const InvoiceOnly = lazy(() => import("../features/Finance/Invoices/InvoiceOnly"));
...
const AuthRedirect = () => {
  const { token, isInitialized } = useSelector((s) => s.auth || {});
  const storedToken = localStorage.getItem("token");
  if (!isInitialized && (token || storedToken)) return <LayoutWithRole />;
...
const router = createBrowserRouter([
...

  {
    ...
    children: [
      ...
      { path: "reports/manifest", element: <CustomerManifest /> },
      { path: "reports/packinglist", element: <PackingList /> },
      { path: "reports/loadinglist", element: <LoadingList /> },
      { path: "reports/deliverylist", element: <DeliveryList /> },
