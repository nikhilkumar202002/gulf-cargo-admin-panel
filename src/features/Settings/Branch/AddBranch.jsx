...
import { createBranch, getPhoneCodes } from "../../../services/coreService";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (form.logoFile) {
        ...
        created = await createBranch(fd, token);  // must forward as multipart/form-data
      } else {
        created = await createBranch(payload, token);
      }
