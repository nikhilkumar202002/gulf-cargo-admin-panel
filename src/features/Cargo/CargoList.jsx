...
/* APIs */
import { listCargos } from "../../services/cargoService";
import { getShipmentStatuses, getActiveBranches } from "../../services/coreService";
...
export default function AllCargoList() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const statusRes = await getShipmentStatuses(); 
