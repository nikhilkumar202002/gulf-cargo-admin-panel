...
function ResetPassword() {
  ...
  useEffect(() => {
    if (!email) {
      ...
      const t = setTimeout(() => navigate("/forgotpassword"), 2000);
  ...
  return (
    <div className="reset-password">
      <div className="reset-password-form">
        ...
        {/* FIXED: Heading should say Reset Password */}
        ...
        <form onSubmit={handleResetPassword}>
          ...
          {message && (
            <p className="form-message" style={{ marginTop: 12, color: message.includes("Error") || message.includes("Missing") ? "red" : "green" }}>
              {message}
            </p>
          )}
        </form>
